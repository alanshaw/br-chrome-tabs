...
var tabTemplate = fs.readFileSync(__dirname + '/chrome-tabs.html');
...
var chromeTabs = {
  ...
  /**
   * Insert chrome-tabs CSS into the page head
   */
  insertCss: function () {
    insertCss(fs.readFileSync(__dirname + '/chrome-tabs.css'));
  }
};
